                ...
                var oConfig = {
                    ...
                    sCSS:
                        ...
                        '.ipsTag {' +
                          ...
                          'background:
    url("https://i.servimg.com/u/f55/18/17/62/92/tag_bg10.png") repeat
                ...
                jQuery.each(tags, function(index, data) {
                    if(data.length > iTagLength) {
                        $('#tags_search').append(
                          ...
                          '<a id="tag_search_' + index + '"
    class="ipsTag" title="' + sTagToolTip + ' ' + data + '"
    href="/search?search_keywords=' + data + '">' +
                            '    <span>' + data + '</span>' +
                            '</a>'
                        );
                    }
